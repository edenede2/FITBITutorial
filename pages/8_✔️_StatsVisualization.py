...
st.header("1. What is the 'Stats Visualization' page?")
...
st.header("2. How do we load the 'Stats Visualization' page?")
...
st.header("3. How do we interpret the plots in the 'Stats Visualization' page?")
