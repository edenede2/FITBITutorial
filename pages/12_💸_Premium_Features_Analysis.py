...
with st.expander("1. How to extract the HRV data for all subjects?"):
...
with st.expander('Example subject HRV Temperature Respiratory At Sleep file'):
    table, code = spreadsheet(pl.read_csv(r"pages/assets/sub_026HRVTemperatureRespiratoryAtSleep.csv", encoding="ISO-8859-1").to_pandas())

    st.write(table)
    st.code(code, language='python', line_numbers=True)

with st.expander('Example Summary Of HRV Temperature Respiratory At Sleep file'):
    table, code = spreadsheet(pl.read_csv(r"pages/assets/SummaryOfHRVTemperatureRespiratoryAtSleep.csv", encoding="ISO-8859-1").to_pandas())
...
st.subheader("HRV Respiratory and Temperature features dictionary")
