...
with st.expander('Example subject HRV Temperature Respiratory At Sleep file'):
    table, code = spreadsheet(pl.read_csv(r"sub_026HRVTemperatureRespiratoryAtSleep.csv", encoding="ISO-8859-1").to_pandas())

    st.write(table)
    st.code(code, language='python', line_numbers=True)

with st.expander('Example Summary Of HRV Temperature Respiratory At Sleep file'):
    table, code = spreadsheet(pl.read_csv(r"SummaryOfHRVTemperatureRespiratoryAtSleep.csv", encoding="ISO-8859-1").to_pandas())
